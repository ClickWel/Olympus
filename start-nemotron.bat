...
set ANTHROPIC_MODEL=nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free
set CLAUDE_CODE_SKIP_FAST_MODE_ORG_CHECK=1
"%LOCALAPPDATA%\Microsoft\WindowsApps\wt.exe" -w new new-tab --title "Nemotron 30b" --tabColor "#76B900" --startingDirectory "D:\Olympus" -- cmd /k "%USERPROFILE%\.local\bin\claude.exe"
